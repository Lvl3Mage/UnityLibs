...
namespace CameraManagement2D
{
	public struct CameraState
	{
		...
		public CameraState DecayPositionTo(CameraState target, float factor)
		{
			...
			position = Interpolation.Decay(position.Value, target.position.Value, Time.deltaTime, factor);
			return this;
		}
		...
		public CameraState DecayZoomTo(CameraState target, float factor)
		{
			...
			zoom = Interpolation.DecayZoom(zoom.Value, target.zoom.Value, Time.deltaTime, factor);
			return this;
		}
		/// <summary>
		...
		public CameraState DecayRotationTo(CameraState target, float factor)
		{
			...
			rotation = Interpolation.DecayAngle(rotation.Value, target.rotation.Value, Time.deltaTime, factor);
			return this;
		}
